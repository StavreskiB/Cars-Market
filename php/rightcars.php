...
//podatoci za oglas
$oglasires = pg_query($dbconn, "select ggg.slika, ggg.slika1, ggg.slika2, ggg.slika3, o.id_oglas, kk.ime, kk.grad, kk.telefon, kk.email, o.naslov, o.opis_oglas, o.chas, o.datum, m.ime_marka, o.model, o.godina, g.ime_gorivo, mm.ime_menuvac, r.tip_registracija, k.ime_karoserija, b.ime_boja, o.sila, o.cena, o.pominati_kilometri 
                                        from oglas as o 
                                        ...
                                        natural join korisnik as kk where o.sila > '150' and o.nov_oglas = 1
