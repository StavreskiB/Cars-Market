...
//podatoci za oglas
$oglasires = pg_query($dbconn, "select gal.slika, gal.slika1, gal.slika2, gal.slika3, o.id_oglas, kk.ime, kk.grad, kk.telefon, kk.email, o.naslov, o.opis_oglas, o.chas, o.datum, m.ime_marka, o.model, o.godina, g.ime_gorivo, mm.ime_menuvac, r.tip_registracija, k.ime_karoserija, b.ime_boja, o.sila, o.cena, o.pominati_kilometri 
                                        from oglas as o 
                                        ...
                                        natural join galerija as gal
                                        where o.sila > '150' and o.nov_oglas = 1 
                                        order by o.sila desc  
                                        limit 6
                                                                        ");
...
foreach($oglasi as $array)
    echo '
    <!-- cars right n1 -->
    <div class="mt-2 classhover" data-toggle="modal" data-target="#ModalRight'.$array['id_oglas'].'">
        <h4 class="badge_class"><span class="badge badge-primary">Премиум</span></h4>
        <span class="image_number_icon ml-2 mt-2"><i class="fa fa-image mr-1"></i>4</span>
        <img class="card-img-top img-right-side" alt="" src='.$array['slika'].'>
    </div>
    
    <!-- modal right n1-->
    <div class="modal" id="ModalRight'.$array['id_oglas'].'" role="dialog">
                ...
                <div class="modal-body">
                    ...
                    <div class="row border-bottom text-white">
                        <div class="col-12 p-0">
                            <!--Carousel Wrapper-->
                            <div id="carousel-right-'.$array['id_oglas'].'" class="carousel slide carousel-fade z-depth-1-half" data-ride="carousel">
                                <!--Indicators-->
                                <ol class="carousel-indicators">
                                    <li data-target="#carousel-right-'.$array['id_oglas'].'" data-slide-to="0" class="active"></li>
                                    <li data-target="#carousel-right-'.$array['id_oglas'].'" data-slide-to="1"></li>
                                    <li data-target="#carousel-right-'.$array['id_oglas'].'" data-slide-to="2"></li>
                                    <li data-target="#carousel-right-'.$array['id_oglas'].'" data-slide-to="3"></li>
                                </ol>
                                <!--/.Indicators-->
                                <!--Slides-->
                                ...
                                <!--/.Slides-->
                                <!--Controls-->
                                <a class="carousel-control-prev" href="#carousel-right-'.$array['id_oglas'].'" role="button" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next" href="#carousel-right-'.$array['id_oglas'].'" role="button" data-slide="next">
