...
if(isset($_POST["getnewCars"])){
    ...
    $num_rows = pg_num_rows($oglasires);
    ...
    foreach($oglasi as $array)
        echo '
            <tr><form method="post">
              ...
              <td><button name="accept" type="submit" class="btn btn-dark"> Дозволи за објава </button></td></form>
            </tr>';
    echo'
          </tbody>
        </table>
    ...
    {
        echo '<h3>Во моментов нема огласи кои не се одобрени</h3>';
    }
...
if (isset($_POST["accept"])) {
    ...
    echo "<script type='text/javascript'>alert('Огласот е објавен!');</script>";
